...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', '-c', type=str, default='configs/rtdetrv2/rtdetrv2_r18vd_sp3_120e_visdrone_p2.yml')
    parser.add_argument('--resume', '-r', type=str, default='output/rtdetrv2_r18vd_sp3_120e_visdrone_FocusFeature_ConFusion_PACFusionMiMBlock1_FPN_FocusFeature_FusionMiMBlock2_PAN_tbfusionP2_cosGIou_4wass_val_540/bestAP50.pth')
